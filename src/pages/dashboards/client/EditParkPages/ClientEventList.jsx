...
function ClientEventList() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      try {
        const response = await fetch('http://localhost:3000/park/64271153a725c6be244a9e94/events', {
          method: 'GET',
          mode: 'cors',
        });
        if (!response.ok) {
  ...
  const handleEditEvent = (updatedEvent) => {
    ...
    console.log(formData)
        ...
        fetch('http://localhost:3000/park/64271153a725c6be244a9e94/event/update', {
          method: 'PUT',
  ...
  const handleEventSubmit = (newEvent) => {
    ...
    console.log(formData)
        ...
        // Make a POST request to the backend API to save the updated home data
        fetch('http://localhost:3000/park/64271153a725c6be244a9e94/event', {
          method: 'PUT',
